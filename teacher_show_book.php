       ...
       while($f=mysqli_fetch_array($q)){
		...
		<div class="child">
            ...
            <label>Book Price :<?php  echo $f['BookPrice'];?></label>
          	<a href="delete_book.php?id=<?php  echo $f['booknumber'];?>"><button id="delete">Delete</button></a>

          	<a href="update_book.php?id=<?php  echo $f['booknumber'];?>"><button id="update">Update</button></a>
