...
<label id="formtitle">Student Login</label></center>
<form action="loginvalidation.php" method="GET"><br><br><br><br><br>
	<label>Enter Your Email id</label><input type="email" name="em" placeholder="Enter Your Email id" required><br><br><br>
		...
		<button id="back"><a href="registration.php">Registration</a></button>
</form>
